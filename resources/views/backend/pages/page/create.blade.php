                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <input type="text"
                                    ...
                                    name="page_title" id="page_title" value="{{ old('page_title') }}"
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea
                                    ...
                                    name="page_description" rows="5" id="page_description">{{ old('page_description') }}</textarea>
                              ...
                              <div class="form-group">
                                 ...
                                 <img class="col-md-3" src="{{ asset('images/default.png') }}"
                                    alt="Page Image" height="199px" width="318px" id="pic">
