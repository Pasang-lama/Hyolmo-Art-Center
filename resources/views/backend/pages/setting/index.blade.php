                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="phone_number" name="phone_number"
                              value="{{ old('phone_number') ? old('phone_number') :  $setting->phone_number }}">
                         @error('phone_number')
                              <span class="text-danger">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="mobile_number" name="mobile_number"
                              value="{{ old('mobile_number') ? old('mobile_number') : $setting->mobile_number }}">
                           @error('mobile_number')
                              <span class="text-danger">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="facebook_link" name="facebook_link"
                              value="{{ old('facebook_link') ? old('facebook_link') : $setting->facebook_link }}">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="instagram_link" name="instagram_link"
                              value="{{ old('instagram_link') ? old('instagram_link') : $setting->instagram_link }}">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="youtube_link" name="youtube_link"
                              value="{{ old('youtube_link') ? old('youtube_link') : $setting->youtube_link }}">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="tiktok_link"
                              name="tiktok_link" value="{{ old('tiktok_link') ? old('tiktok_link') : $setting->tiktok_link }}">
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="google_map" id="google_map"
                              class="form-control">{{ old('google_map') ? old('google_map') : $setting->google_map }}</textarea>
