   ...
   <div class="container">
      <div class="row gy-4">
         ...
         <div class="col-lg-5 col-md-12 col-sm-12">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="name">
                           ...
                           <input type="text" name="name" id="name"
                              value="{{ auth()->user()->name }}" required><br>
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="number ">
                           ...
                           <input type="number" name="number" id="number"
                              value="{{ auth()->user()->phone }}" required><br>
                           <span class="error-message pt-3 text-danger"></span>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="email ">
                           ...
                           <input type="email" name="email" id="email"
                              value="{{ auth()->user()->email }}"required><br>
                           <span class="error-message pt-3 text-danger"></span>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="provience ">
                           ...
                           <select name="provience" id="provience">
                              ...
                              @if ($province_id == $province->id) {{ "selected='selected'" }} @endif>
                           ...
                           @error('provience')
                           <span
                              class="error-message pt-3 text-danger">{{ $errors->first('provience') }}</span>
                           @enderror
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="district">
                           ...
                           @error('district')
                           <span
                              class="error-message pt-3 text-danger">{{ $errors->first('district') }}</span>
                           @enderror
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <input
               class="form-check-input {{ $errors->has('payment_method') ? 'is-invalid' : '' }}"
               type="radio" value="cod" name="payment_method" id="payment_method_cod"
               required>
            ...
            <div class="terms">
            <div class="form-check">
            <input class="form-check-input {{ $errors->has('remember') ? 'is-invalid' : '' }}"
               type="checkbox" name="remember" id="termsconditions_chk" required>
            <label class="form-check-label" for="termsconditions_chk">
            I have read and agree to the websites <a href="{{ route('frontend.pages_details', ['terms-condition']) }}" target="_blank">Terms &
            Conditions</a>
            </label>
            @error('remember')
            <span class="text-danger">
