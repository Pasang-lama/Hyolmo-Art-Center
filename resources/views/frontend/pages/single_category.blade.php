               ...
               <form action="{{ route('product.filter') }}" method="GET" id="filter-form">
                  ...
                  <div class="filter-single-check">
                     ...
                     <div class="form-check">
                        ...
                        @if (!empty($_GET['recommended']) && $_GET['recommended'] === 'recommended') checked @endif name="recommended" id="recommended">
                        <label class="form-check-label">
                        Recommended
                        </label>
                     </div>
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="latest" @if (!empty($_GET['latest_product']) && $_GET['latest_product'] === 'latest') checked @endif
                        name="latest_product" id="latest_product">
                     ...
                     <div class="form-check">
                        ...
                        value="{{ isset($min_price) ? $min_price : 1 }}" name="min_price"
                        @if (!empty($_GET['min_price']) && $_GET['min_price'] == '1') checked @endif id="min_price">
                        <label class="form-check-label" for="flexCheckDefault">
                        Lowest Price
                        </label>
                     </div>
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox"
                        value="{{ isset($max_price) ? $max_price : 1000000 }}" name="max_price"
                        @if (!empty($_GET['max_price']) && $_GET['max_price'] == '1000000') checked @endif id="max_price">
                        <label class="form-check-label" for="flexCheckDefault">
                        Highest Price
                        </label>
                     </div>
                  ...
                  <div class="filter-single-check">
                     ...
                     <div class="form-check">
                        ...
                        @if (!empty($_GET['brand']) && $_GET['brand'] == $brand->name) checked @endif id="brands" name="brand">
                        <label class="form-check-label" for="flexCheckDefault">
                        {{ $brand->name }}
                        </label>
                     </div>
                  ...
                  <div class="filter-single-check">
                     ...
                     <div class="form-check">
                        ...
                        value="{{ $color->color_name }}" @if (!empty($_GET['color']) && $_GET['color'] === $color->color_name) checked @endif id="colors">
                        <label class="form-check-label" for="flexCheckDefault">
                        {{ $color->color_name }}
                        </label>
                     </div>
                  ...
                  <div class="card-product">
                     <a href="{{ route('main_product', $product->slug) }}">
                        ...
                        <ul class="shop-feature">
                           <li>
                     <a data-bs-toggle="tooltip" data-bs-placement="top"  title="Search " href="{{ route('main_product', $product->slug) }}"><i
